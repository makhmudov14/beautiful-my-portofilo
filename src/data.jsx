...
export const projects = [
  ...
  {
    id: nanoid(),
    img: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8am9ic3RlciUyMHBpY3xlbnwwfHwwfHx8MA%3D%3D',
    url: 'https://asadbek-jobster.netlify.app/landing',
    github: 'https://github.com/makhmudov14/jobster',
    title: 'Job-searching App project',
    text: 'Welcome to Job Seeker Hub, your go-to platform for navigating the exciting landscape of career opportunities. Whether you are a seasoned professional looking to elevate your career or a recent graduate embarking on your professional journey, Job Seeker Hub is here to make your job search seamless and rewarding',
  },
];
